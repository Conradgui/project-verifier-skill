#!/usr/bin/env python3
"""Validate decision-envelope authorization with standard-library Python."""
...
def build_parser():
    parser = argparse.ArgumentParser(description="Validate project-verifier decision envelopes")
    subparsers = parser.add_subparsers(dest="command", required=True)
    check = subparsers.add_parser("check", help="Validate one authorization receipt")
